# Copied from https://github.com/lookout/lookout-foodcritic-rules/blob/master/lib/foodcritic/rules/lkout001.rb

rule "OP009", "Include a chefspec test for every recipe" do
